...
interface SidebarProps {
	currentPage: 'home0' | 'home' | 'analysis' | 'devices' | 'yijie' | 'login' | 'garbage1' | 'garbage2' | 'garbage3';
	setCurrentPage: React.Dispatch<React.SetStateAction<'home0' | 'home' | 'analysis' | 'devices' | 'yijie' | 'login' | 'garbage1' | 'garbage2' | 'garbage3'>>;
}
